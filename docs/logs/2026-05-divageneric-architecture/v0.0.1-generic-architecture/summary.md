...
- 根据后续确认，新增 Plan Mode 架构章节：固化 `.laputa/plans/<plan-id>/`、`plan.md`、`exploration_findings.md`、`state.json`、`events.jsonl`、`verification.md`、`evidence/` 等文件名，并定义 Explore -> Plan -> Execute -> Verify 四阶段、approval gate、verification verdict、PlanOrchestrator 边界和实施路线。
