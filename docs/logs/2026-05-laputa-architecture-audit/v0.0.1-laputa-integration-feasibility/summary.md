...
2. 节律设计是否过复杂
3. HA'S-PROJECT 概念中哪些值得保留、哪些应拒绝
4. 已开发内容的状态
...
| HA'S-PROJECT 概念悄悄回流 | 复杂度膨胀 | D-009 作为红线，新概念必须对照拒绝清单 |
...
| HA'S-PROJECT 兼容性分析 | `laputa-next/docs/dev/legacy/ha's-project-study/HA'S-PROJECT与DIVA-Soul兼容性分析.md` |
| HA'S-PROJECT 执行摘要 | `laputa-next/docs/dev/legacy/ha's-project-study/executive-summary.md` |
