...
- `2026-07-08`: Codex released the provider model pass-through lock after making `LiteLLMClient::resolve_model()` preserve configured model IDs exactly, adding StepFun/custom-provider regression coverage, recording `docs/logs/2026-07-provider-model-pass-through/v0.0.1-provider-model-pass-through/`, and logging the deferred StepFun real endpoint E2E validation in `TODOLIST.md`.
