...
.plan-approval-badge { border: 1px solid #bfdbfe; border-radius: 999px; padding: 4px 9px; color: #1d4ed8; background: var(--line, #dbeafe); font-size: 11px; }
...
.plan-approval-details, .plan-context-choice { display: flex; flex-direction: column; gap: 9px; margin-top: 12px; padding: 12px; border: 1px solid #bfdbfe; border-radius: 10px; color: var(--text-muted, #667085); background: var(--panel-solid, rgba(255, 255, 255, .62)); font-size: 12px; }
