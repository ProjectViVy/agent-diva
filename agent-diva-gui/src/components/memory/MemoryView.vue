...
.workspace-title { display: flex; align-items: center; gap: var(--space-2, 8px); }
.workspace-tabs { display: flex; gap: var(--space-1, 4px); padding: var(--space-2, 8px) 18px; border-bottom: 1px solid var(--line); overflow-x: auto; }
...
.error-banner { margin: var(--space-2, 8px) 18px 0; padding: var(--space-2, 8px) 10px; color: var(--danger-deep, #b91c1c); background: color-mix(in srgb, #ef4444 10%, transparent); border-radius: var(--radius-sm); }
...
.record-row { width: 100%; display: flex; flex-direction: column; align-items: flex-start; gap: 5px; padding: var(--space-3, 12px) 14px; text-align: left; border: 0; border-bottom: 1px solid var(--line); background: transparent; color: var(--text); cursor: pointer; }
...
.editor-pane, .record-detail, .rules-editor { height: 100%; display: flex; flex-direction: column; min-height: 0; }.content-textarea { flex: 1; min-height: 220px; margin: 14px; resize: none; padding: var(--space-3, 12px); border: 1px solid var(--line); border-radius: var(--radius-sm); color: var(--text); background: var(--panel-solid); }
...
.read-content, .section-card pre, .capsule-detail pre { margin: 0; padding: var(--space-4, 16px); white-space: pre-wrap; overflow-wrap: anywhere; font: 13px/1.6 var(--font-mono, ui-monospace); }
.meta-list { padding: 0 var(--space-4, 16px); }.meta-list div { display: grid; grid-template-columns: 120px 1fr; padding: var(--space-2, 8px) 0; border-top: 1px solid var(--line); }.meta-list dt { color: var(--text-muted); }
.actmem-layout { grid-template-columns: minmax(0, 1fr) 320px; }.actmem-head { padding-bottom: 20px; }.capsule-panel { border-right: 0; border-left: 1px solid var(--line); }.section-card { margin: 14px; border: 1px solid var(--line); border-radius: var(--radius-sm); overflow: hidden; }.section-card-title { padding: 9px var(--space-3, 12px); border-bottom: 1px solid var(--line); }.section-card pre { max-height: 220px; overflow: auto; }.capsule-detail { margin: var(--space-3, 12px); border: 1px solid var(--line); border-radius: var(--radius-sm); }.capsule-detail .section-card-title { align-items: flex-start; overflow-wrap: anywhere; }
