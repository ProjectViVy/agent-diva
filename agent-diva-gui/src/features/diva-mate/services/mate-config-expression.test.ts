...
import { applyExpressionDefaultMigration, migrateConfig } from './mate-config'
...
describe('applyExpressionDefaultMigration', () => {
  it('enables vrmExpressionEnabled once when the migration key is missing', () => {
    ...
    expect(setItem).toHaveBeenCalledWith('agent-diva-mate-expression-default-enabled-migrated-v1', '1')
  })
